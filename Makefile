...
CXXFLAGS += $(WARNING_FLAGS) -I. -I./include $(PLATFORM_CXXFLAGS) $(OPT) -Wno-maybe-uninitialized -Wno-format-truncation -Wno-implicit-fallthrough -Wno-expansion-to-defined -Woverloaded-virtual -Wnon-virtual-dtor -Wno-missing-field-initializers
